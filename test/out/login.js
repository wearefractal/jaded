  ...
  return rivets.bind($(target)[op](function anonymous(locals, attrs, escape, rethrow, merge) {
    ...
    try {
      ...
      with (locals || {}) {
        ...
        buf.push('<span data-text="auction.timeRemaining | seconds">');
        __jade.unshift({
          lineno: undefined,
          filename: __jade[0].filename
        });
        ...
        buf.push('<div data-show="auction.endingSoon" class="alert-box">');
        __jade.unshift({
          lineno: undefined,
          filename: __jade[0].filename
        });
        ...
        buf.push('<input type="text" data-value="auction.bidder"/>');
        __jade.shift();
        __jade.unshift({
          lineno: 16,
          filename: __jade[0].filename
